...
## **Challenge**
Given a list of GitHub Usernames through a POST request, return all of the usernames' IDs and Public SSH Keys in JSON. Some people may have more than one Public SSH Keys.
...
```
As you can see, for the Username it could not find, it returned its Username but filled in both the ID and Key field with 'N/A'. For my username, allengng, it returned my one and only ID and Key, and for mjluck, it returedn all 3 of his Ids and Keys.
